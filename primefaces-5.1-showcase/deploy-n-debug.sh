...
./sync-source &
echo ""
echo "http://localhost:8080/showcase-5.1/"
echo "http://localhost:8080/showcase-5.1/ui/data/datatable/filter.xhtml"
echo "http://localhost:8080/showcase-5.1/ui/data/datatable/lazy.xhtml"
echo
echo
