...
<f:view>
	...
	<h:panelGrid columns="2" columnClasses="top, top">
		...
		<rich:pickList value="#{avMasterMaintenanceHandler.result}" sourceListWidth="150" targetListWidth="200"> 
			<f:selectItems value="#{avMasterMaintenanceHandler.reportOptions}"/>
		</rich:pickList>
