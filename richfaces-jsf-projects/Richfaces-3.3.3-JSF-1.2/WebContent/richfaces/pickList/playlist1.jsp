...
<f:view>
	<h:form>
		<h:panelGrid columns="2" columnClasses="top 70per, top 30per" width="700px">
		<rich:orderingList value="#{library.songsList}" var="lib" listHeight="200" listWidth="350" 
		...
		<rich:panel id="output" header="Selected Item" style="overflow:auto; width:300px; height:200px">
			...
			<h:outputText value="No items selected" rendered="#{empty library.selectedSongsList}"/>
		</rich:panel>
		</h:panelGrid>
	</h:form>
</f:view>
